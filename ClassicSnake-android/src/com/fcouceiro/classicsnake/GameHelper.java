...
public class GameHelper implements GooglePlayServicesClient.ConnectionCallbacks,
    ...
    public void setup(GameHelperListener listener, int clientsToUse) {
        ...
        if (0 != (clientsToUse & CLIENT_GAMES)) {
            ...
            mGamesClient = new GamesClient.Builder(getContext(), this, this).setGravityForPopups(Gravity.TOP | Gravity.CENTER_HORIZONTAL)
                    .setScopes(mScopes)
                    .create();
        }
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        Toast.makeText(getContext(),"onConnected: connected! client=" + mClientCurrentlyConnecting, Toast.LENGTH_LONG);
    ...
    public void onConnectionFailed(ConnectionResult result) {
        ...
        Toast.makeText(getContext(), "onConnectionFailed: result " + result.getErrorCode(), Toast.LENGTH_LONG);
        dismissDialog();
